					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ZMATERIAL_COST",
									"targetURL": "#ypfproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypfproject1-display": {
								"semanticObject": "ypfproject1",
								"action": "display",
								"description": "Carga masiva de precios costos materiales",
								"title": "ZMATERIAL_COST",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.project1",
									"url": sap.ui.require.toUrl("ypf/project1")
								}
							}
						}
					}
